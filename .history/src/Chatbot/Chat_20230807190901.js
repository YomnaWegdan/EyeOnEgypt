...
return (
    ...
    <div className=" flex justify-end px-3 transition-5 " style={{  borderRadius: '12px 12px 12px 0', width:'31%',marginTop:'20px',  marginLeft:'65%' ,  position:'fixed' , zIndex:'10'}}>
    
    <div className="  flex justify-center  mt-2 py-2 border-t-2 " style={{height:'60px', backgroundColor:'#FFF5E3' }}   >

      <p style={{color:'rgb(60, 47, 6)'}} className='mx-4 mt-2'>EyeOnEgypt</p>
