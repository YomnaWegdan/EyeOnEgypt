...
const Chat = () => {
  ...
  const [currentMessage, setCurrentMessage] = useState(JSON.parse(window.localStorage.getItem("chat")||""))
  ...
  useEffect(()=>{
    window.localStorage.setItem("chat", JSON.stringify(currentMessage , responses,image))
},[currentMessage , responses,image])
