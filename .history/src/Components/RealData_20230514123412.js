export const ancientSites = [
    ...
    },
    {
       ...
       // img : require('../images/Rectangle 159.png'),
        img : require('../images/Rectangle 121.png'),
        location:'Giza',
        title:'ancientSites', data:'Luxor Temple, Ipet-resyt “Southern Sanctuary” to the ancient Egyptians, was so called because of its location within ancient Thebes (modern Luxor). It is located around three kilometers to the south of Karnak Temple, to which it was once linked with a processional way bordered with sphinxes. The oldest evidence for this temple dates to the Eighteenth Dynasty (c.1550–1295 BC).
