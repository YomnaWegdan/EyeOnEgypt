  ...
  return(
    ...
    {favorites.length>0? favorites.map((el)=>{
      ...
      return(
         ...
         <CardItem srcImg={el.img} id={el.id} name={el.name} title={el.title} link={el.link} el = {el}/>   
          ...
          <div className='location'>
                ...
                <NavLink to={`${el.link}`} style={{color:'#644F0A', textDecoration:'none'}}> <span className='m-1' >{el.location}</span></NavLink></div>
