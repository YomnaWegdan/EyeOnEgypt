...
import image from '../images/Group 33092.png'
const Footer = () => {
  return (
    <Fragment>
        <div className=" ">
        ...
        <div className="container">
            <section style={{color:'#FFAE0C'}}>
                ...
                <NavLink to="/" >               
                  <img src={image} alt='' style={{width:'100%' , height:'70%'}}/>
                </NavLink>
      ...
      <section >
        <div className="row d-flex justify-content-center" style={{marginTop:'-50px'}}>
          <div className="col-lg-8 ">
            ...
            Guide is Specializes in providing most Placing Egypt with all information
