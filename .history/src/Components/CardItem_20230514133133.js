 ...
 const [love , setLove] = useState(false);
    ...
    return (
        ...
        <NavLink to={`/${props.title}/${props.id}`}>   
            ...
            <div className='heart'> 
                <span style={{display:'inline-block', marginRight:'auto'}}>{props.name}</span>
                <span key={props.id} style={{color: '#FF4E02',cursor:'pointer',marginRight:'auto'}} onClick={()=>  setLove((prevLike)=> !prevLike)}
            >
