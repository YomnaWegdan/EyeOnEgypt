...
const Footer = () => {
  return (
    <Fragment>
        <div className=" ">
        <footer className="text-center mt-5 " style={{ backgroundColor:'rgba(100, 79, 10, 0.65)' , marginTop:'10px'}}>
      ...
      <section >
        <div className="row d-flex justify-content-center" style={{marginTop:'-50px'}}>
          <div className="col-lg-8 ">
            ...
            EyeOnEgypt is specializes in providing most Egypt places with all information
