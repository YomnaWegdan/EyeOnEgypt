  ...
  return (
    ...
    <BsLock style={{position:'absolute' , marginTop:'11px' , marginLeft:'6px', color:'#644F0A'}}/>
        ...
        <Form.Control type="password" placeholder="Password" className='px-4' onChange={(e)=> setPassword(e.target.value)} value={password}/>
                ...
                <div style={{borderColor:'black' , color:'#644F0A'}} className='mb-4 text-center  '>Already have an account <NavLink  className="nav-link d-inline-block" to="/signup">Sign up</NavLink> </div>

                <div className='mb-4 text-center d-inline-block' style={{ color:'#644F0A'}}>Already have an account <NavLink className="nav-link" to="/login">Login</NavLink></div>
