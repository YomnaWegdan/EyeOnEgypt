export const ancientSites = [
    ...
    },
    {
        ...
        data:'This beautiful and remarkably well-preserved monument is the largest free-standing temple in Lower Nubia. It was built during the reign of Augustus (30 BC–14 AD), the first Roman emperor. Primarily dedicated to the Nubian god Mandulis, the gods Isis and her husband Osiris were worshipped here too. The temple is standard in its plan. A monumental gateway called a pylon leads into an open-air forecourt followed by a columned hall, called a hypostyle hall. Two transversal chambers lie beyond which served as halls for offerings. At the far end of the temple is the sanctuary, where the cult image of the god was kept. A partly rock-cut chapel to the Nubian god Dedwen lies to the south-west, and a small chapel, likely built by Ptolemy IX in the 2nd century BC, is located to the north-east.  
