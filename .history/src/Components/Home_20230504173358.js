...
*/
const Home = () => {
  const {name, data , handleSearch,  onSearch ,isSubmit } = useAppContext();
...
<BsSearch />
  ...
  {/*  <div style={{marginInline:'10%' , color:'#644F0A' , width:'80%',marginTop:'30px' , textAlign:'center'}}>
      ...
      <div style={{marginInline:'10%' , marginTop:'40px' }}>
        <div  style={{width:'52%' , paddingTop:'120px' , marginRight:'3%' , display:'inline-block'}}>
        ...
        <img src={img1} alt='' style={{width:'46%' , height:'420px', marginTop:'-80px', position:'relative', borderRadius:'30% 6% 30% 6%' }}/>
