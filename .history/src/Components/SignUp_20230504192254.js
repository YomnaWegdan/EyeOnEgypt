...
/*
  ...
  return (
    ...
    <Form   className='loginForm  mx-auto' style={{ marginLeft:'60px' , marginRight:'60px' , marginTop:'60px'  }}>
        <img src={logo}  className=' w-50 h-50 text-center mb-4 mx-auto' alt='logo'/>
