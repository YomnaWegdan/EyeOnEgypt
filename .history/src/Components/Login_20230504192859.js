...
const Login = () => {
    ...
    <Container>
        ...
        <Form   className='loginForm  ' style={{ marginLeft:'100px' , marginRight:'-40px' ,  marginTop:'130px'}}>
        ...
        <Button type="submit" className='btn w-100 mb-4 ' style={{ background: 'orange' , color:'#644F0A', border: 'none'}}>Login</Button>

        <div style={{borderColor:'black' , color:'#644F0A'}} className='mb-4 text-center  '>Or Login With</div>
