...
const Login = () => {
    ...
    <Container>
        ...
        <Button type="submit" className='btn w-100 mb-4' style={{ background: 'orange',color:'#644F0A' , border: 'none'}}> <NavLink className="nav-link" to="/">Login</NavLink></Button>

        <div style={{borderColor:'black' , color:'#644F0A'}} className='mb-4 text-center  '>Don't have an account? <NavLink className="nav-link" to="/signup">Sign up</NavLink> </div>
