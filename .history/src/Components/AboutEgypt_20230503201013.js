...
const AboutEgypt = () => {
  ...
  {/*  <img src={image} alt=''  height={260} style={{width:'540px', float:'right', marginTop:'340px'  , marginRight:'-35.5%' }}/>*/}
            ...
            <h3 className='fw-bold ' style={{color:'#d08c11'> Egypt History</h3>    
