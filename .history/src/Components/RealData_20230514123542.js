export const ancientSites = [
    ...
    },
    {
        ...
        data:'The Temple of Ramesses III at Medinet Habu was an important New Kingdom period temple structure in the West Bank of Luxor in Egypt. Aside from its size and architectural and artistic importance, the mortuary temple is probably best known as the source of inscribed reliefs depicting the advent and defeat of the Sea Peoples during the reign of Ramesses III.The first European to describe the temple in modern literature was Vivant Denon, who visited it in 1799–1801. Jean-François Champollion described it in detail in 1829.
        ...
        The further excavation, recording, and conservation of the temple have been facilitated in chief part by the Architectural and Epigraphic Surveys of the University of Chicago Oriental Institute, almost continuously since 1924.'
