...
const Login = () => {
    ...
    <Container>
        ...
        <Button type="submit" className='btn w-100 mb-4 ' style={{ background: 'orange' , color:'#644F0A', border: 'none'}}>  <NavLink to={SignUp}>Sign up</NavLink>Login</Button>

        <div style={{borderColor:'black' , color:'#644F0A'}} className='mb-4 text-center  '>Don't have an account? <NavLink to={SignUp}>Sign up</NavLink> </div>
